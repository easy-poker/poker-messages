...
export declare type ClientMessage = ClientCreateTableMessage | ClientJoinTableMessage | ClientLeaveTableMessage | ClientRequestTableStateMessage | ClientStartGameMessage | ClientDealMessage | ClientPlaceBetMessage | ClientFoldMessage | ClientCallMessage | ClientCheckMessage;
export declare const isClientMessage: (x: any) => x is ClientMessage;
